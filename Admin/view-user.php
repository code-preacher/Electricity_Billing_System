...
<?php if (isset($_SESSION['admin'])):
  ...
  $q = $db->prepare("select title,name,passkey,phone,mobile,email  from user_data order by id");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
?>
              ...
              <div class="row">
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    ...
                    <div class="card-body">
                      <?php if ($n > 0):
                          $q->bind_result($t, $n, $p, $pn, $mn, $e);
                          $c = 1;
                      ?>
                       <div class="form-group">
                              <label for="ccnumber">Search for User By Meter Number</label>
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for User By Meter Number"  required>
                            </div>
