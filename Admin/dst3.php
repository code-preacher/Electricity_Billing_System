...
<?php if (isset($_SESSION['admin'])): 
  ...
  $q = $db->prepare("select mobile,card,amount,date from recharge order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
...
#myTable tr.header, #myTable tr:hover {
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Recharge Card Stats</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                          $q->bind_result($m, $n, $s, $j);
                          $c = 1;
                      ?>
 ...
 <th>Date</th>
                      ...
                      <?php else: ?>
                        <h3>There are no Recharge Card Stats on this System at the moment.</h3>
