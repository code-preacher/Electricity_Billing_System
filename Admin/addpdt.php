                    ...
                    <div class="card-body">
                      <form  action="auth2.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="pn" class="form-control" id="dob"   required>
                            </div>
                          </div>
                        </div>
                        <!--/.row-->
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label for="ccnumber">Quantity</label>
                              <input type="text" name="qty" class="form-control" id="dob"  required>
                            </div>
                          </div>
                        </div>
                        <!--/.row-->
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              ...
                              <input type="text" name="pr" class="form-control" id="dob"  required>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
							...
							<input type="submit" name="ub" value="Update data" class="btn btn-primary btn-lg">
