...
<?php if (isset($_SESSION['admin'])): 
  ...
  $q = $db->prepare("select mobile,plan from user_no order by id");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Generated Customer Meter Numbers</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                      ...
                      <?php else: ?>
                        <h3>There are no Generated Customer meter numbers on this System at the moment.</h3>
