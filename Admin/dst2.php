...
<?php if (isset($_SESSION['admin'])): 
  ...
  $q = $db->prepare("select digit,amount,status from card order by id desc");
  $q->execute();
  $q->store_result();
  $n = $q->num_rows;
                ...
                <div class="col-md-8 col-md-offset-2">
                  <div class="card">
                    <div class="card-header">
                      <strong>Generated Recharge Cards</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <?php if ($n > 0):
                      ...
                      ?>
                       ...
                       <div class="form-group">
                              <label for="ccnumber">Search for Generated Recharge Cards</label>
                              <input type="text" id="myInput" onkeyup="myFunction()" class="form-control"  placeholder="Search for Generated Recharge Cards"  required>
                            </div>
             <table id="myTable" class="table  table-bordered">
                          <thead>
                            <tr>
                              <th>#</th>
                              <th>Recharge digit</th>
							  <th>Amount </th>
                               <th>Status</th>
                      ...
                      <?php else: ?>
                        <h3>There are no Generated Recharge Cards on this System at the moment.</h3>
