                ...
                <div class="col-sm-6">
                  <div class="card">
                    <div class="card-header">
                      <strong>Light Charge @ ₦1 per seconds</strong>
                      <small></small>
                    </div>
                    <div class="card-body">
                      <form  action="add2.php" method="post">
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group">
                              <label for="ccnumber">Light Duration (in seconds)</label>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <input type="submit" name="bb" value="USE LIGHT" class="btn btn-primary btn-lg">
                          </div>
                        </div>
                      </form>
                    </div>
